...
int DataManager::getTakenSeatsInTrain(int stationStartNumber, int stationEndNumber) {
    SQLite::Database db(DATABASE_PATH, SQLite::OPEN_READONLY);
...
int DataManager::getTakenSeatsInCar(int stationStartNumber, int stationEndNumber, int carNumber) {
    SQLite::Database db(DATABASE_PATH, SQLite::OPEN_READONLY);
    SQLite::Statement query(db, "SELECT COUNT(*) FROM Passengers WHERE "
        "TripID = ? AND "
        "CarNumber = ? AND "
...
int DataManager::getTakenSeatsInCompartment(int stationStartNumber, int stationEndNumber, int carNumber, int compartmentNumber) {
    SQLite::Database db(DATABASE_PATH, SQLite::OPEN_READONLY);
    SQLite::Statement query(db, "SELECT COUNT(*) FROM Passengers WHERE "
        "TripID = ? AND "
        "CarNumber = ? AND "
